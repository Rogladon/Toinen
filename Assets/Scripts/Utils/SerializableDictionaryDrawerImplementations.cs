...
// ---------------
//  string => EnvironmentObject
// ---------------
[UnityEditor.CustomPropertyDrawer(typeof(StringEnvironmentObjectDictionary))]
public class StringEnvironmentObjectDictionaryDrawer : SerializableDictionaryDrawer<string, EnvironmentObject> {
	protected override SerializableKeyValueTemplate<string, EnvironmentObject> GetTemplate() {
		return GetGenericTemplate<SerializableStringEnvironmentObjectTemplate>();
	}
}
internal class SerializableStringEnvironmentObjectTemplate : SerializableKeyValueTemplate<string, EnvironmentObject> { }
}
